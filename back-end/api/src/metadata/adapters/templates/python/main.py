...
The script must:
    1. Read from CLIMSOFT_INPUT_FILE
    2. Process the data
...
def main():
    input_file = os.environ['CLIMSOFT_INPUT_FILE']
    output_file = os.environ['CLIMSOFT_OUTPUT_FILE']
    ...
    print(f"Processing file: {metadata.get('originalFileName', 'unknown')}")
