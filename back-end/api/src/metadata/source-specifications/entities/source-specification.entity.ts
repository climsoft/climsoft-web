...
@Entity("source_templates") // TODO. change to `source_specifications` later
...
export class SourceSpecificationEntity extends AppBaseEntity {
    ...
    /**
     * Optional FK to a pre-import or pre-data entry adapter. When set, the adapter is invoked
