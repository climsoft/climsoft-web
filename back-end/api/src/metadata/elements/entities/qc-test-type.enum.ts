export enum QCTestTypeEnum {
    ...
    // Checks if the observed value remains constant over a predefined number of consecutive records. 
    // And also checks whether the same value occurs at a specific time (e.g., the same hour each day) across a specified number of consecutive records. 
    FLAT_LINE = "flat_line",
