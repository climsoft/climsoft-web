...
import { ElementColumnMappingDto, StationColumnMappingDto } from './metadata-import-preview.dto';
...
export class MetadataImportPreviewController {
    ...
    public async updateBaseParams(
        ...
        const skip: number = rowsToSkip > 0 ? rowsToSkip : 0;
        const delim: string | undefined = delimiter || undefined;
        return this.metadataImportPreviewService.updateBaseParamsAndPreviewRawData(sessionId, skip, delim);
    }
