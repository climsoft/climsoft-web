...
export class SeedElements1710833167092 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(SeedElements1710833167092.INSERT_ELEMENTS);
    }
    ...
    public static INSERT_ELEMENTS = `
     ...
     (5, 'SUNSHN', 'Sunshine Total', '', 'Minutes', 3, 1 ),
     ...
     (16, 'VAPPRESS', 'Vapour Pressure', '', 'Kpa', 5, 1 ),
