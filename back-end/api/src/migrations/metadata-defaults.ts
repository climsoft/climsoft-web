...
export class MetadataDefaults {
    ...
    public static FLAGS: ViewFlagDto[] = [
        { id: 1, abbreviation: 'M', name: 'Missing', description: 'No observation was made', comment: null },
        { id: 2, abbreviation: 'E', name: 'Estimate', description: 'Estimated value', comment: null },
        { id: 3, abbreviation: 'D', name: 'Dubious', description: 'Dubious/questionable value', comment: null },
