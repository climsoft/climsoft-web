...
export abstract class BaseEntity {
    ...
    @JoinColumn({ name: "entry_user_id", foreignKeyConstraintName: "fk_elements_users" }) // Configures the foreign key to be set to NULL upon deletion of the referenced User
