...
REQUIRED_VARS="DB_HOST DB_PORT DB_NAME DB_USERNAME DB_PASSWORD ENCRYPTION_SECRET FIRST_INSTALL V4_SAVE V4_IMPORT V4_DB_HOST V4_DB_PORT V4_DB_NAME V4_DB_USERNAME V4_DB_PASSWORD V4_DB_UTCOFFSET"
