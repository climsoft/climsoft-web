...
import { ViewStationObsEnvironmentModel } from '../models/view-station-obs-environment.model';
...
export class StationObsEnvironmentsService {
  ...
  public getStationObsEnvironments(ids?: number[]): Observable<ViewStationObsEnvironmentModel[]> {
