export enum QCTestTypeEnum {
    ...
    // checks whether the same value occurs at a specific time (e.g., the same hour each day) across a specified number of consecutive records. 
    // and also Checks if the observed value remains constant over a predefined number of consecutive records.
    FLAT_LINE = "flat_line", 
